...
describe('getPath', () => {
  ...
  <body>
	...
	describe('element with id', () => {
		beforeEach(() => {
			//arrange
			const secondListItemElement =
				dom.window.document.getElementById(secondListElementId)
	...
	describe('element with class', () => {
		beforeEach(() => {
			//arrange
			const firstListItemElement = dom.window.document.getElementsByClassName(
				firstListElementClassName
			)[0]
	...
	describe('element without class and id in collection', () => {
		beforeEach(() => {
			//arrange
			const thirdListItemElement =
				dom.window.document.getElementsByTagName('ul')[0].children[2]
